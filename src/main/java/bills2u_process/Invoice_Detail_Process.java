...
public class Invoice_Detail_Process extends Root_Class {
    ...
    public static void selectItemName() throws IOException {
        try {
           getTestData();
            ...
            if (objInvoice.itemSelectedName.getText().equals(objInvoice.itemSelectedName.getText().toString())) {
    ...
    public static void checkAmount() throws IOException {
        try {
            ...
            if (objInvoice.amountValue.getAttribute("value").equals(objInvoice.amountValue.getAttribute("value").toString())) {
