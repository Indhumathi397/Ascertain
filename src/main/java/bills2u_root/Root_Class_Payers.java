...
public class Root_Class_Payers {
    ...
    public static Logger log = Logger.getLogger(Root_Class.class.getName());
    ...
    public static void main(String[] args) throws InterruptedException {
     ...
     /*   Option billersUrlOption = new Option("bu", "BillersURL", true, "BILLER'S URL");
        billersUrlOption.setRequired(true);
        options.addOption(billersUrlOption);

        Option billerUsernameOption = new Option("buser", "BillersUser", true, "BILLER'S USERNAME");
        billerUsernameOption.setRequired(true);
        options.addOption(billerUsernameOption);

        Option billerPasswordOption = new Option("bPass", "BillersPass", true, "BILLER'S PASSWORD");
        billerPasswordOption.setRequired(true);
        options.addOption(billerPasswordOption);

        Option logDirOption=new Option("cl","ChromeLog",true,"CHROMEDRIVER LOG");
        ...
        reportPayer.flush();
        watch.stop();
        long timeInteravalSec = watch.getTime(TimeUnit.SECONDS);
        long timeInteravalMin = watch.getTime(TimeUnit.MINUTES);
        long timeInteravalhr = watch.getTime(TimeUnit.HOURS);
        System.out.println("************************************************************************************************");
        System.out.println("Total number of Time Taken to execute the program in Seconds:" + timeInteravalSec);
        System.out.println("Total number of Time Taken to execute the program in Minutes:" + timeInteravalMin);
        System.out.println("Total number of Time Taken to execute the program in Hours:" + timeInteravalhr);
        System.out.println("************************************************************************************************");
    }
    ...
    public static void initProcess() {
        ...
        try {
            driver.get(prop.getProperty("payersUrl"));
